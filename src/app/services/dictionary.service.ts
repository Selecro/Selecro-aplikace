...
import {Styl} from '../types'
 ...
 const poleStylu = [{nazev: "retizkove-oko", titulek: "Řetízkové oko", zkratka: "Řo", popis: "Vytvoříme si jednoduchý uzlík, který upevníme přímo na háček. Utahujeme pouze tak, aby prošla další příze. Naberu na háček a přitáhnu vytvořeným okem. Opakováním tohoto tahu vytvářím řetěz." },
  ...
  {nazev: "dlouhy-sloupek", titulek: "Dlouhý sloupek", zkratka: "Ds", popis: "Nabereme přízi na háček a teprve potom zajedeme do vytvořeného oka. Protáhnu a na háčku mám nyní 3krát ovinutou přízi. Naberu na háček a tuto přízi protáhnu všemi třemi." },
  {nazev: "polodlouhy-sloupek", titulek: "Polodlouhý sloupek", zkratka: "Pds", popis: "Do vytvořené řady řo najdu první oko. Do oka zajedu háčkem a protáhnu přízí na druhou stranu. Na háčku se mi nyní objeví 2 nahozené provázky, znovu naberu přízi na háček a provleču ji těma dvěma, co už tam čekaly." },
